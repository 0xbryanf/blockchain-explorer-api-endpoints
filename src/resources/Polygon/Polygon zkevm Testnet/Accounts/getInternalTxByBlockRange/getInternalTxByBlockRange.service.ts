import { ApiParams } from '@/resources/Polygon/Polygon zkevm Testnet/Accounts/getInternalTxByBlockRange/getInternalTxByBlockRange.interface';
...
class PolyZKEVMTestnetTxByBlockRangeService {
...
export default PolyZKEVMTestnetTxByBlockRangeService;